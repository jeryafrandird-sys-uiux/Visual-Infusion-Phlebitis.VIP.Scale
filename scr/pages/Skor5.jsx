...
export default function Skor5() {
  ...
  const handleSubmit = () => {
    ...
    createMutation.mutate({
      ...
      iv_site: finalIvSite,
      vip_score: 5,
      symptoms: ['Nyeri di sepanjang jalur kanula', 'Kemerahan di sekitar lokasi', 'Bengkak', 'Pembengkakan vena yang teraba (terasa), dan', 'Pireksia (demam)'],
      action_taken: 'Pindahkan kanula, inisiasi perawatan phlebitis',
      ...
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        <Card className="mb-6">
          <CardContent className="pt-6 text-center">
            <div className="flex justify-center mb-4">
              <div className="w-20 h-20 rounded-full bg-[#7c2d5e] flex items-center justify-center text-white font-bold text-4xl shadow-lg">
                5
              </div>
            </div>
            <h2 className="text-2xl font-bold text-[#2c3e5f] mb-6">Skor 5</h2>
            
            <div className="mb-6">
              <img 
                src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/694161f617aa933f3fd01621/0260ab0a4_Gemini_Generated_Image_bomyiubomyiubomy.png"
                alt="Skor 5"
            ...
            <div className="bg-gray-100 rounded-lg p-4 mb-4">
              ...
              <p className="text-gray-600 text-sm">Semua tanda-tanda berikut, terbukti dan ekstensif (meluas):</p>
              <ul className="text-gray-600 text-sm mt-2 text-left max-w-md mx-auto">
                <li>• Nyeri di sepanjang jalur kanula,</li>
                <li>• Kemerahan di sekitar lokasi,</li>
                <li>• Bengkak,</li>
                <li>• Pembengkakan vena yang teraba (terasa), dan;</li>
                <li>• Pireksia (demam).</li>
              </ul>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mb-6">
          <CardContent className="pt-6">
            ...
            <div className="bg-[#e9d5f5] rounded-lg p-4">
              <p className="text-[#581c87] text-center font-medium">Tromboflebitis tahap lanjut.</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mb-6">
          <CardContent className="pt-6">
            ...
            <div className="bg-[#e9d5f5] rounded-lg p-4">
              <p className="font-bold text-[#581c87] mb-2">MULAI TERAPI</p>
              <ul className="text-[#581c87] space-y-1 text-sm">
                <li>• Lepas kanula segera.</li>
                <li>• Bersihkan bekas area bekas insersi.</li>
                <li>• Pantau tanda-tanda sepsis.</li>
                <li>• Lakukan pemeriksaan kultur ujung kateter dan darah vena, (jika ada pus/tanda infeksi sistemik).</li>
                <li>• Pasang infus kembali, (jika diperlukan).</li>
                <li>• Jika memerlukan terapi jangka panjang, pertimbangkan pemasangan PICC.</li>
                <li>• Kolaborasi untuk terapi antibiotik dan analgesik.</li>
