...
export default function Skor2() {
  ...
  const handleSubmit = () => {
    ...
    createMutation.mutate({
      ...
      iv_site: finalIvSite,
      vip_score: 2,
      symptoms: ['Nyeri di lokasi intravena, dan/atau', 'Kemerahan, dan/atau', 'Bengkak'],
      action_taken: 'Pindahkan kanula',
      ...
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        <Card className="mb-6">
          <CardContent className="pt-6 text-center">
            <div className="flex justify-center mb-4">
              <div className="w-20 h-20 rounded-full bg-[#f3b878] flex items-center justify-center text-white font-bold text-4xl shadow-lg">
                2
              </div>
            </div>
            <h2 className="text-2xl font-bold text-[#2c3e5f] mb-6">Skor 2</h2>
            
            <div className="mb-6">
              <img 
                src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/694161f617aa933f3fd01621/4f8d957ab_Gemini_Generated_Image_8fjo8y8fjo8y8fjo.png"
                alt="Skor 2"
            ...
            <div className="bg-gray-100 rounded-lg p-4 mb-4">
              ...
              <p className="text-gray-600 text-sm">Dua dari tanda-tanda berikut terbukti:</p>
              <ul className="text-gray-600 text-sm mt-2 text-left max-w-md mx-auto">
                <li>• Nyeri di lokasi intravena, dan/atau;</li>
                <li>• Kemerahan, dan/atau;</li>
                <li>• Bengkak</li>
              </ul>
            </div>
          </CardContent>
        ...
        <Card className="mb-6">
          <CardContent className="pt-6">
            ...
            <div className="bg-[#fed7aa] rounded-lg p-4">
              <p className="text-[#92400e] text-center font-medium">Flebitis tingkat awal.</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mb-6">
          <CardContent className="pt-6">
            ...
            <div className="bg-[#fed7aa] rounded-lg p-4">
              <p className="font-bold text-[#92400e] mb-2">PINDAHKAN KANULA</p>
              <ul className="text-[#92400e] space-y-1 text-sm">
                <li>• Hentikan infus.</li>
                <li>• Lepas/cabut kanula intravena.</li>
                <li>• Pasang infus dilokasi baru (ekstremitas berbeda jika memungkinkan).</li>
                <li>• Dokumentasi kejadian.</li>
                <li>• Area bekas infus dibersihkan, elevasi ekstremitas, dan berikan kompres hangat.</li>
              </ul>
            </div>
          </CardContent>
        </Card>
