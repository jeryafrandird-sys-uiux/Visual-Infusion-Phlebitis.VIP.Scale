...
export default function Skor4() {
  ...
  const handleSubmit = () => {
    ...
    createMutation.mutate({
      ...
      iv_site: finalIvSite,
      vip_score: 4,
      symptoms: ['Nyeri di sepanjang jalur kanula', 'Kemerahan di sekitar lokasi', 'Bengkak, dan', 'Pembengkakakn vena yang teraba (terasa)'],
      action_taken: 'Pindahkan kanula, pertimbangkan perawatan phlebitis',
      ...
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        <Card className="mb-6">
          <CardContent className="pt-6 text-center">
            <div className="flex justify-center mb-4">
              <div className="w-20 h-20 rounded-full bg-[#b44c5c] flex items-center justify-center text-white font-bold text-4xl shadow-lg">
                4
              </div>
            </div>
            <h2 className="text-2xl font-bold text-[#2c3e5f] mb-6">Skor 4</h2>
            
            <div className="mb-6">
              <img 
                src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/694161f617aa933f3fd01621/db448d7cb_Gemini_Generated_Image_3r9w523r9w523r9w1.png"
                alt="Skor 4"
            ...
            <div className="bg-gray-100 rounded-lg p-4 mb-4">
              ...
              <ul className="text-gray-600 text-sm mt-2 text-left max-w-md mx-auto">
                ...
                <li>• Bengkak, dan;</li>
                <li>• Pembengkakakn vena yang teraba (terasa).</li>
              </ul>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mb-6">
          <CardContent className="pt-6">
            ...
            <div className="bg-[#f4c2c2] rounded-lg p-4">
              <p className="text-[#7f1d1d] text-center font-medium">Flebitis tahap lanjut atau awal tromboflebitis.</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mb-6">
          <CardContent className="pt-6">
            ...
            <div className="bg-[#f4c2c2] rounded-lg p-4">
              <p className="font-bold text-[#7f1d1d] mb-2">PINDAHKAN KANULA & PERTIMBANGKAN TERAPI</p>
              <ul className="text-[#7f1d1d] space-y-1 text-sm">
                <li>• Lepas kanula segera.</li>
                <li>• Pasang infus di lokasi baru.</li>
                <li>• Elevasi ekstremitas.</li>
                <li>• Lakukan kompres (hangat/dingin sesuai SOP) dan manajemen nyeri.</li>
                <li>• Kolaborasi untuk pertimbangkan terapi antibiotik/anti-inflamasi, jika ada infeksi. Evaluasi resiko trombosis.</li>
                <li>• Dokumentasi kejadian.</li>
              </ul>
            </div>
          </CardContent>
        </Card>
